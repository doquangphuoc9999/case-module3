...
<header id="header">
    <div class="container main-menu">
        <div class="row align-items-center justify-content-between d-flex">
            <div id="logo">
                <a href="/admin"><img src="${pageContext.request.contextPath}/resources/home-blog/img/logo.png" alt="" title="" /></a>
            </div>
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    <li><a href="/admin">Home</a></li>
                    <li class="menu-active"><a href="/homeBlog?action=about">About</a></li>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 home-about-left">
                <img class="img-fluid" src="${pageContext.request.contextPath}/resources/home-blog/img/iphone.png" alt="">
            </div>
    ...
    <div class="container">
        <div class="testi-slider owl-carousel" data-slider-id="1">
            <div class="item">
                <div class="testi-item">
                    <img src="${pageContext.request.contextPath}/resources/home-blog/img/quote.png" alt="">
                    <h4>Fanny Spencer</h4>
                    <ul class="list">
        ...
        <div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
            <div class="owl-thumb-item">
                <div>
                    <img class="img-fluid" src="${pageContext.request.contextPath}/resources/home-blog/img/testimonial/t1.jpg" alt="">
                </div>
                <div class="overlay overlay-grad"></div>
            </div>
            <div class="owl-thumb-item">
                <div>
                    <img class="img-fluid" src="${pageContext.request.contextPath}/resources/home-blog/img/testimonial/t2.jpg" alt="">
                </div>
                <div class="overlay overlay-grad"></div>
            </div>
            <div class="owl-thumb-item">
                <div>
                    <img class="img-fluid" src="${pageContext.request.contextPath}/resources/home-blog/img/testimonial/t3.jpg" alt="">
                </div>
                <div class="overlay overlay-grad"></div>
            </div>
            <div class="owl-thumb-item">
                <div>
                    <img class="img-fluid" src="${pageContext.request.contextPath}/resources/home-blog/img/testimonial/t4.jpg" alt="">
                </div>
                <div class="overlay overlay-grad"></div>
            </div>
        </div>
