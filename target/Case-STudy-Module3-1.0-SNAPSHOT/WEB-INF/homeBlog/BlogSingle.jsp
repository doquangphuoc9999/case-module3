                ...
                <div class="single-post row">
                    <div class="col-lg-12">
                        <div class="feature-img">
                            <img class="img-fluid" src="${postById.image}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-3  col-md-3 meta-details">
                        <ul class="tags">
                            <li><a href="#">${postById.category.nameCategory}</a></li>
...
<%--                            <li><a href="#">Lifestyle</a></li>--%>
                    ...
                    <div class="col-lg-9 col-md-9">
                        <h3 class="mt-20 mb-20">${postById.title}</h3>
                        <p class="excert">
                            ${postById.shortContent}
                        </p>
                    </div>
                    <div class="col-lg-12">
                        <div class="quotes">
                            ${postById.fullContent}
                        </div>
...
<%--                                </p>--%>
                        ...
                        <c:forEach var="list" items="${listComment}">
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    ...
                                    <div class="desc">
                                        <h5><a href="#">${list.nameUser}</a></h5>
                                        <p class="date">${list.publisht}</p>
                                        <p class="comment">
                                                ${list.content}
                                        </p>
                                    </div>
                ...
                <div class="comment-form">
                    ...
                    <form method="post" action="/homeBlog?action=commentPost">
                        <input type="hidden" name="id" value="${postById.id}">
                        <div class="form-group form-inline">
                            <div class="form-group col-lg-6 col-md-12 name">
                                <input type="text" class="form-control" id="name" name="nameUser" placeholder="Enter Name" onfocus="this.placeholder = ''"
                                       onblur="this.placeholder = 'Enter Name'">
                            </div>
                            <div class="form-group col-lg-6 col-md-12 email">
                                <input type="email" class="form-control" id="email" name="gmailUser" placeholder="Enter email address" onfocus="this.placeholder = ''"
