                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <strong>Edit Post</strong> Form
                                </div>
                                <div class="card-body card-block">
                                    <form action="/admin?action=editPost" method="post" class="form-horizontal">
                                        <input type="hidden" name="id" value="${PostById.id}">
                              ...
                              width: 100%;
                              border-radius: 8px;
                            " cols="30" rows="10">${PostById.shortContent}</textarea>
                                        </div>
                                        <label>Full content</label>
                                        <textarea name="fullContent" id="fullcontentSummernote">${PostById.fullContent}</textarea>
                                        <div class="row">
                                            <div class="col-10">
                                                <select name="category" class="select">
<%--                                                    <c:forEach items="${listCategory}" var="list">--%>
<%--                                                       <c:if test="${list.id == PostById.category.id}">--%>
<%--                                                            <option selected value="${list.id}">${list.nameCategory}</option>--%>
<%--                                                       </c:if>--%>
<%--                                                        <c:if test="${list.id != PostById.category.id}">--%>
...
<%--                                                    </c:forEach>--%>
                                                    <c:forEach var="list" items="${listCategory}">
                                                        <option ${PostById.category.id == list.id ? "selected" : ""} value="${list.id}">
                                                            ${list.nameCategory}
                                                        </option>
                                                    </c:forEach>
                                                ...
                                                <select name="user" class="select">
                                                    ...
                                                    <c:if test="${sessionScope.user.statusUser != 2}">
                                                        <c:forEach var="list" items="${listUsers}">
                                                            <option ${PostById.user.id == list.id ? "selected" : ""} value="${list.id}">
                                                                    ${list.nameUser}
                                                            </option>
                                                        </c:forEach>
                                                    </c:if>
