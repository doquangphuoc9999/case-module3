                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-data__tool">
                            ...
                            <div class="table-data__tool-right">
                                <a href="/admin?action=addGetPostAdmin">
                                    <button
                        ...
                        <div class="table-responsive table-responsive-data2">
                            ...
                            <tbody>
                                 <c:if test="${sessionScope.user.statusUser != 2}">
                                    <c:forEach var="list" items="${listPostAdmin}">
                                    <tr class="tr-shadow">
                                        <td></td>
                                        <td>${list.id}</td>
                                        <td>${list.title}</td>
                                        <td><img src="${list.image}" style="width: 100px;" alt="Image"></td>
                                        <td>${list.publisht}</td>
                                        <td>${list.user.nameUser}</td>
                                        <td>${list.user.nickname}</td>
                                        <td>${list.category.nameCategory}</td>
                                        <td>
                                            <div class="table-data-feature">
                                                <button class="item" data-toggle="tooltip" data-placement="top"  title="Edit">
                                                    <a href="admin?action=editPost&id=${list.id}">
                                                            <i class="zmdi zmdi-edit"></i>
                                                    </a>
                                                </button>
                                                <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                                    <a href="admin?action=deleteTryPost&id=${list.id}" onclick="return confirm('Bạn có chắc chắn muốn xóa bài viết này không')">
                                 ...
                                 <c:if test="${sessionScope.user.statusUser == 2}">
                                     <c:forEach var="list" items="${listPostByUser}">
                                         <tr class="tr-shadow">
                                             <td></td>
                                             <td>${list.id}</td>
                                             <td>${list.title}</td>
                                             ...
                                             <td>
                                                 <div class="table-data-feature">
                                                     ...
                                                     <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                                         <a href="admin?action=deletePost&id=${list.id}" onclick="return confirm('Bạn có chắc chắn muốn xóa bài viết này không')">
                                                             <i class="zmdi zmdi-delete"></i>
                                                         </a>
                                                     </button>
                                                     <button
