                            ...
                            <div class="card">
                                <div>
                                    <c:if test="${mess.size() == 0}">
                                        <div class="alert alert-success" role="alert" style="height: 40px; margin-top: 38px">Sửa thành công</div>
                                    </c:if>
                                    <c:if test="${mess.size() != 0}">
                                ...
                                <div class="card-body card-block">
                                    <form action="/admin?action=editCategory" method="post" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input name="nameCategory" value="${categoryById.nameCategory}" required class="form-control" />
                                            </div>
                                        </div>
