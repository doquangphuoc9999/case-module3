                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div>
                                    <c:choose>
                                        <c:when test='${messs.size() == 0}'>
                                            <div class="alert alert-success" role="alert" style="height: 40px; margin-top: 38px">Add is success</div>
                                        </c:when>
                                        <c:otherwise>
                                            <c:forEach items="${messs}" var="mess">
                                                <div class="alert alert-danger" role="alert" style="height: 40px; margin-top: 38px">${mess}</div>
                                            </c:forEach>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                                ...
                                <div class="card-body card-block">
                                    <form action="/admin?action=addUser" method="post" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input name="nickname" placeholder="Enter Nickname..." required class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input name="password" type="password" required placeholder="Enter password..." class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input name="image" placeholder="Enter link images..." required class="form-control" />
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input name="gmail" type="email" placeholder="Enter gmail..." required class="form-control" />
                                            </div>
                                        </div>
                                        <div>
