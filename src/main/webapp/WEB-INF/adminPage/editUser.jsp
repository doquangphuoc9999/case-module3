                        ...
                        <div class="header-button">
                            <div class="account-wrap">
                                <div class="account-item clearfix js-item-menu">
                                    <div class="image">
                                        <img src="${pageContext.request.contextPath}/resources/admin/images/icon/avatar-01.jpg" alt="John Doe" />
                                    </div>
                                    <div class="content">
                            ...
                            <div class="card">
                                <div>
                                    ...
                                    <c:if test="${mess.size() == 0}">
                                        <div class="alert alert-success" role="alert" style="height: 40px; margin-top: 38px">Update is success</div>
                                    </c:if>

                                    <c:if test="${mess.size() != 0}">
                                        <c:forEach items="${mess}" var="listError">
                                            <div class="alert alert-danger" role="alert" style="height: 40px; margin-top: 38px">${listError}</div>
                                        </c:forEach>
                                    </c:if>
                                ...
                                <div class="card-body card-block">
                                    <form action="/admin?action=editUser" method="post" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input name="name" value="${user.nameUser}" required class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input name="nickname" value="${user.nickname}" required class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input name="password" type="password" required value="${user.passWordUser}" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">Link images</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input name="image" value="${user.image}" required class="form-control" />
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input name="gmail" type="email" value="${user.gmailUser}" required class="form-control" />
                                            </div>
                                        </div>
                                        <div>
                                            <label>Introduce</label>
                                            <textarea name="introduce" required style="
                              border: 1px solid #dddddd;
                              width: 100%;
                              border-radius: 8px;
                            " cols="30" rows="10">${user.introduce}</textarea>
                                        </div>
                                        <div class="card-footer">
                                            ...
                                            >
                                                <a style="color: #fff" href="/admin?action=listAuthor">
